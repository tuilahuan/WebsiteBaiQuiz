    ...
    <>
      <div className="register-main">
        ...
        <div className="register-container">
          ...
          <div className="title">TuiLaHuan</div>
            ...
            <div className="password">
              ...
              {hiddenPassword ? (
                <span className="icon-hidden">
                  <IoIosEye onClick={() => handleClickShowPassword()} />
                </span>
              ) : (
                <span className="icon-hidden">
                  <IoIosEyeOff onClick={() => handleClickShowPassword()} />
                </span>
              )}
            </div>
            <div className="password">
              ...
              {hiddenRePassword ? (
                <span className="icon-hidden">
                  <IoIosEye onClick={() => handleClickShowRePassword()} />
                </span>
              ) : (
                <span className="icon-hidden">
                  <IoIosEyeOff onClick={() => handleClickShowRePassword()} />
                </span>
              )}
            </div>
            <div>
